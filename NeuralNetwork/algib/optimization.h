...
1. This function has two different implementations: one which  uses  exact
   ...
   your optimization scheme! Table below vectors different  combinations  of
...
Table below vector  optimization  protocols  (XYZ  protocol  corresponds  to
...
OUTPUT PARAMETERS:
    ...
    Rep     -   optimization  report;  includes  termination   codes   and
                additional information. Termination codes are vectored below,
